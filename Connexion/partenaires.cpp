...
*/
//rechercher
QSqlQueryModel *Partenaire::rechercher(int ref)
{
    QSqlQueryModel * model1=new QSqlQueryModel();
    QString res=QString::number(ref);


    model1->setQuery("Select * from GEST_PART where ID_PART LIKE '"+res+"%'");
    model1->setHeaderData(0, Qt::Horizontal, QObject::tr(":ID_PART"));
    model1->setHeaderData(1, Qt::Horizontal, QObject::tr("PR_PART"));
    model1->setHeaderData(2, Qt::Horizontal, QObject::tr("ADRESSE_PART"));
    model1->setHeaderData(3, Qt::Horizontal, QObject::tr("NM_PART"));

    model1->setHeaderData(4, Qt::Horizontal, QObject::tr("FONCT_PART"));
    model1->setHeaderData(5, Qt::Horizontal, QObject::tr("SALAIRE_PART"));
    model1->setHeaderData(6, Qt::Horizontal, QObject::tr("EMAIL_PART"));

    model1->setHeaderData(7, Qt::Horizontal, QObject::tr("NUMTEL_PART"));
