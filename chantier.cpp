#include "chantier.h"
#include "ui_chantier.h"
#include "qrcode.h"
Chantier::Chantier(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::Chantier)
{
    ui->setupUi(this);
...
QSqlQueryModel *Chantier:: trie_C()
{
    QSqlQueryModel *model=new QSqlQueryModel();
...
QSqlQueryModel *Chantier:: trie_Emp()
{
    QSqlQueryModel *model=new QSqlQueryModel();

    model->setQuery("select * from GESTION_CHANTIER order by EMPLACE" );
    model->setHeaderData(0,Qt::Horizontal,QObject::tr("id"));
    model->setHeaderData(1,Qt::Horizontal,QObject::tr("emplace"));
    model->setHeaderData(2,Qt::Horizontal,QObject::tr("surface"));
    model->setHeaderData(3,Qt::Horizontal,QObject::tr("plan"));
...
QSqlQueryModel *Chantier::rechercherEmp(QString emplace)
{
    QSqlQueryModel * model=new QSqlQueryModel();
    model->setQuery("select * from GESTION_CHANTIER where EMPLACE LIKE '"+emplace+"%'");
    model->setHeaderData(0,Qt::Horizontal,QObject::tr("id"));
    model->setHeaderData(1,Qt::Horizontal,QObject::tr("emplace"));
    model->setHeaderData(2,Qt::Horizontal,QObject::tr("surface"));
    model->setHeaderData(3,Qt::Horizontal,QObject::tr("plan"));
