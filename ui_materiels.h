...
public:
    ...
    void setupUi(QDialog *materiels)
    {
        ...
        materiels->resize(796, 456);
        stackedWidget = new QStackedWidget(materiels);
        stackedWidget->setObjectName(QStringLiteral("stackedWidget"));
        stackedWidget->setGeometry(QRect(0, 0, 811, 451));
...
"}"));
        ...
        pushButton_ajou->setGeometry(QRect(190, 30, 261, 71));
        QFont font;
...
"}"));
        ...
        pushButton_affi->setGeometry(QRect(200, 260, 261, 61));
...
"}"));
        ...
        comboBox_dispo->setGeometry(QRect(80, 200, 119, 21));
...
"}"));
        ...
        label_waiting->setGeometry(QRect(270, 210, 91, 71));
        label_click = new QLabel(groupBox_2);
        label_click->setObjectName(QStringLiteral("label_click"));
        label_click->setGeometry(QRect(530, 220, 81, 41));
        label_click->setStyleSheet(QStringLiteral("background-color:transparent;"));
...
"border-radius:20px;"));
        ...
        pushButton_notification->setFont(font);
...
"}"));
        ...
        horizontalFrame->setGeometry(QRect(-71, -10, 821, 471));
    ...
    void retranslateUi(QDialog *materiels)
    {
        ...
        groupBox->setTitle(QApplication::translate("materiels", "Gestion des mat\303\251riels", Q_NULLPTR));
        ...
        pushButton_bkaf->setText(QApplication::translate("materiels", "Back", Q_NULLPTR));
