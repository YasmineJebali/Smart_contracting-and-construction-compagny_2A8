...
""));
        ...
        label_backi = new QLabel(modules);
        label_backi->setObjectName(QStringLiteral("label_backi"));
        label_backi->setGeometry(QRect(0, -10, 841, 611));
        label_backi->raise();
        label_buble->raise();
        label_pers->raise();
